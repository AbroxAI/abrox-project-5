// app-fixed.js — Telegram 2026 FINAL (Header typing fully restored)
document.addEventListener("DOMContentLoaded", () => {
  ...
  style.textContent = `
    ...
    .tg-header-typing-inline, .tg-header-typing .user-typing-wrapper {
      display: inline-flex;
      align-items: center;
      gap: 2px;
      font-size: 12px;
    ...
    .tg-header-typing-inline .typing-dots, .tg-header-typing .typing-dots {
      display: inline-flex;
      gap: 2px;
      margin-left: 0;
    }
  ...
  /* =========================
     Global typing queue (simulate typing delay)
  ========================= */
...
✅ To verify or contact admin, use the Contact Admin button below.`;
  ...
  function showPinBanner(image,pinnedMessageId){
    ...
    img.src=image; img.onerror=()=>img.src="assets/admin.jpg";
    ...
    adminBtn.target="_blank"; adminBtn.rel="noopener";
    adminBtn.textContent="Contact Admin";

    const btnContainer=document.createElement("div");
    btnContainer.className="pin-btn-container";
    btnContainer.appendChild(blueBtn); btnContainer.appendChild(adminBtn);
  ...
  console.log("✅ app-fixed.js FINAL — header typing fully restored, multiple typers, inline dots, join stickers fixed");
});
