// app-fixed.js — Telegram 2026 Integration (header typing fully dynamic, inline dots fixed)
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* =====================================================
     HEADER TYPING MANAGER (dynamic, inline dots, multiple typers)
  ===================================================== */
  ...
  function updateHeaderTyping() {
    ...
    // single wrapper with names + dots
...
✅ To verify or contact admin, use the Contact Admin button below.`;
  ...
  /* =====================================================
     AUTO REPLY & SEND MESSAGE LISTENERS
  ===================================================== */
  ...
  /* =====================================================
     DEMO TYPING — automatic for testing multiple typers
  ===================================================== */
  setTimeout(() => {
    window.headerTypingStart('Alice');
    window.headerTypingStart('Bob');
    window.headerTypingStart('Charlie');

    setTimeout(() => {
      window.headerTypingStop('Alice');
      window.headerTypingStop('Bob');
      window.headerTypingStop('Charlie');
    }, 5000);
  }, 1000);

  console.log("✅ app.js — header typing fully dynamic & inline dots fixed, multiple typers ready");
});
